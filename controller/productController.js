import Product from "../modales/product.js";
...
export async function createProduct(req, res) {
    ...
    try{
        const existingProduct = await productRouter.findOne({
        ...
        if (req.body.name == null){
            req.status(400).json({ message: "Product name is required"});
            return;
        }
        ...
        data.labelledPrice = req.body.labelledPrice;
